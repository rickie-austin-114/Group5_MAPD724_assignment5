...
struct ContentView: View {
    ...
    // store the selected image to PhotoWithFaces Image Type
    ...
    // when selected, detect face and add to photo collection
            ...
            if newValue.count <= 5 {
                ...
                for photo in newValue {
                    do {
                        ...
                        print("Error loading image or image data: \(error)")
                    }
                }
            } else {
